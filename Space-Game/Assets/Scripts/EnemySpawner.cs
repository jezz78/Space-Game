...
public class EnemySpawner : MonoBehaviour
{
    ...
    public float min_Y = -4.6f, max_Y = 4.6f;
    ...
    void Start()
    {
        Invoke("SpawnEnemies", timer);  //uruchomienie SpawnEnemies musi być w Start
    }
    ...
    void SpawnEnemies()
    {
        ...
        Invoke("SpawnEnemies", timer);  //uruchomienie SpawnEnemies
    }
}
